...
public class ShowAllSubmissionController implements Initializable {
    ...
    @FXML
    private void lbl1SubClicked(MouseEvent event) {
    }

    @FXML
    private void lbl2SubClicked(MouseEvent event) {
    }

    @FXML
    private void lbl3SubClicked(MouseEvent event) {
    }

    @FXML
    private void lbl4SubClicked(MouseEvent event) {
    }

    @FXML
    private void lbl5SubClicked(MouseEvent event) {
    }

    @FXML
    private void lbl6SubClicked(MouseEvent event) {
    }

    @FXML
    private void lbl7SubClicked(MouseEvent event) {
    }

    @FXML
    private void lbl8SubClicked(MouseEvent event) {
    }

    @FXML
    private void lbl9SubClicked(MouseEvent event) {
    }

    @FXML
    private void lbl10SubClicked(MouseEvent event) {
    }

    @FXML
    private void lbl11SubClicked(MouseEvent event) {
    }

    @FXML
    private void lbl12SubClicked(MouseEvent event) {
    }
